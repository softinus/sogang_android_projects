...
public class MatanConnection
{
	 ...
	 * 연결된 선이 추가되었음을 알린다.
	 */
	public void AddConnectionPoint(int idx, Point midSpot)
	{
		pConnect[ConnectionNum].setPoint(midSpot);
		info.nShotRoute[ConnectionNum]= idx;

		++ConnectionNum;
		pConnect[ConnectionNum+1].setPoint(midSpot);
		info.nShotRoute[ConnectionNum+1]= idx; // 총알 루트에 추가
	}
